  ...
  module RepositoryManager
    module Admin
      def self.registered(urm)
        ...
        urm.get ADMIN_ACCOUNT_SETTINGS do
          unless logged_in_as_admin?
            redirect NOT_ADMIN
          end
        ...
        # Post method for changing the admin user data and metadata(the user that is currently logged in)
        #
        urm.post ADMIN_ACCOUNT_SETTINGS do
          unless logged_in_as_admin?
            redirect NOT_ADMIN
          end
